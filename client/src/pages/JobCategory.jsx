    ...
    <div className='app'>
      ...
      <div className='max-w-7xl p-10 mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        {!selectedCategory ? (
          ...
          <div className='mt-6'>
            <button onClick={() => setSelectedCategory(null)} className='mb-4 px-4 py-2 bg-gray-200 rounded-md hover:bg-gray-300'>
              ← Back to Categories
            </button>
              ...
              <div className='space-y-6'>
                {filteredJobs.map((job) => (
                  <div key={job._id} className='bg-white rounded-lg shadow-md p-6'>
                    ...
                    <div className='text-gray-500 text-sm'>Location: {job.location}</div>
                    <button
