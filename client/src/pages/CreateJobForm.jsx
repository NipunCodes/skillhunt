                    ...
                    <div className='bg-custom-blue-100 p-12 w-4xl rounded-2xl shadow-lg'>
                        <form>
                            ...
                            <div className='mb-5'>
                                ...
                                <input className='bg-white border border-gray-300 mt-1 h-10 rounded-xl pr-10 w-full focus:outline-none focus:ring-1 focus:ring-blue-300' type="text" name="jobTitle" id="jobTitle" />
                            </div>
                            <div className='mb-5'>
                                <label className='text-xl font-semibold mb-3' htmlFor="jobDescription">Job Description</label>
                                <textarea className='bg-white border border-gray-300 mt-1 h-40 rounded-xl pr-10 w-full focus:outline-none focus:ring-1 focus:ring-blue-300' name="jobDescription" id="jobDescription" placeholder=' Type full description . . .'></textarea>
                            </div>
                            <div className='mb-5'>
                                <label className='text-xl font-semibold mb-3' htmlFor="shortDescription">Short Description</label>
                                <textarea className='bg-white border border-gray-300 mt-1 h-20 rounded-xl pr-10 w-full focus:outline-none focus:ring-1 focus:ring-blue-300' name="shortDescription" id="shortDescription" placeholder=' Type short description . . .'></textarea>
                            </div>
                            <div className='mb-5'>
                                <label className='text-xl font-semibold mb-3' htmlFor="jobCategory">Job Category</label>
                                <select className='bg-white border border-gray-300 mt-1 h-10 rounded-xl pr-10 w-full focus:outline-none focus:ring-1 focus:ring-blue-300' name="jobCategory" id="jobCategory">
