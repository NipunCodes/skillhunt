            ...
            <div className='lg:col-span-1'>
              ...
              <div className='bg-white rounded-lg p-6 shadow-sm mb-6'>
                <div className='flex flex-col items-center mb-4'>
                  {job.companyPicture ? (
                    <img src={job.companyPicture} alt={`${job.companyName} logo`} className='w-20 h-20 rounded-full object-cover mb-3' />
                  ) : (
                    <div className='w-20 h-20 rounded-full bg-gray-200 flex items-center justify-center mb-3'>
                      <span className='text-2xl font-bold text-gray-400'>{job.companyName?.charAt(0)}</span>
                    </div>
                  )}
              ...
              <div className='bg-white rounded-lg p-6 shadow-sm sticky top-4'>
                ...
                <button className='w-full bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition duration-200'>Apply Now</button>
