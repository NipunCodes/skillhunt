...
const UserReviewCard = () => {
  ...
  return (
      <div className='bg-custom-blue-200 border border-gray-400 shadow-[5px_5px_5px_hsla(244,100%,10%,0.493)] p-10 max-w-70 text-center rounded-xl m-10 inline-block'>
