...
const UserReviewCard = () => {
  ...
  return (
      <div className='bg-gray-200 border border-gray-400 shadow-[5px_5px_5px_hsla(244,100%,10%,0.493)] p-10 max-w-70 text-center rounded-xl m-10 inline-block'>
        <img src={DP} alt="profile-pic" className='rounded-full' />
        <h1 className="text-3xl font-semibold text-[rgb(0,50,150)] font-sans mt-5">USER</h1>
